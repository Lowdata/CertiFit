      ...
      <header className="fixed top-0 w-full z-50 border-b border-white/20 dark:border-slate-800/50 bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl transition-all duration-300">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            <a href="#features" className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              Platform
            </a>
            <a href="#how-it-works" className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              How it works
            </a>
          </nav>
        ...
        {menuOpen && (
          <div className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-6 py-6 md:hidden shadow-2xl">
            <div className="flex flex-col gap-6">
              <a href="#features" className="text-base font-medium text-slate-600 dark:text-slate-400" onClick={() => setMenuOpen(false)}>
                Platform
              </a>
              <a href="#how-it-works" className="text-base font-medium text-slate-600 dark:text-slate-400" onClick={() => setMenuOpen(false)}>
                How it works
              </a>
